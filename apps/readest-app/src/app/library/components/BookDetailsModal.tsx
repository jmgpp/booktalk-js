          ...
          <div className="flex flex-col md:flex-row gap-6">
            <div className="flex-shrink-0 w-full md:w-1/3">
              {book.thumbnail_url ? (
                ...
                <div className="w-full aspect-[2/3] bg-base-300 flex items-center justify-center rounded shadow-lg">
            ...
            <div className="flex-1">
              ...
              <div className="mb-4">
                ...
                <select
                  ...
                  value={currentStatus || ''}
                  onChange={(e) => setCurrentStatus(e.target.value as BookStatus || undefined)}
                >
                ...
                <div className="flex items-center mt-1">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <button
                      ...
                      onClick={() => setCurrentRating(star === currentRating ? undefined : star)}
                    >
